...
//
		...
		#define MIM_DISABLE_GCC_WARNING(w) _Pragma("GCC diagnostic push") _Pragma(MIMGCCWHELP2(w))
	#else
		...
		#define MIM_RESTORE_GCC_WARNING() _Pragma("GCC diagnostic pop")
	#else
...
//
...
#if defined(MIM_COMPILER_GNUC) && (MIM_COMPILER_VERSION >= 4006) // Can't test directly for __GNUC__ because some compilers lie.
	#define MIM_ENABLE_GCC_WARNING_AS_ERROR(w) _Pragma("GCC diagnostic push") _Pragma(MIMGCCWERRORHELP2(w))
#else
	...
	#if defined(MIM_COMPILER_GNUC) && (MIM_COMPILER_VERSION >= 4006)
		#define MIM_DISABLE_GCC_WARNING_AS_ERROR() _Pragma("GCC diagnostic pop")
	#else
...
#ifndef MIM_ENABLE_IGNORE_GCC_WARNING
	#if defined(MIM_COMPILER_GNUC) && (MIM_COMPILER_VERSION >= 4006) // Can't test directly for __GNUC__ because some compilers lie.
		#define MIM_ENABLE_IGNORE_GCC_WARNING(w) _Pragma("GCC diagnostic push") _Pragma(MIMGCCIGNOREHELP2(w))
	#else
	...
	#if defined(MIM_COMPILER_GNUC)
		#define MIMGCCIGNOREDISABLEHELP0(x) #x
		#define MIMGCCIGNOREDISABLEHELP1(x) MIMGCCIGNOREDISABLEHELP0(GCC diagnostic warning x)
		#define MIMGCCIGNOREDISABLEHELP2(x) MIMGCCIGNOREDISABLEHELP1(#x)
	#endif
#endif

#ifndef MIM_DISABLE_IGNORE_GCC_WARNING
	#if defined(MIM_COMPILER_GNUC) && (MIM_COMPILER_VERSION >= 4004)
		#define MIM_DISABLE_IGNORE_GCC_WARNING(w) _Pragma(MIMGCCIGNOREDISABLEHELP2(w)) _Pragma("GCC diagnostic pop")
	#else
...
//
	...
	#if defined(MIM_COMPILER_CLANG) || defined(MIM_COMPILER_CLANG_CL)
		#define MIM_RESTORE_CLANG_WARNING() _Pragma("clang diagnostic pop")
	#else
...
//
		...
		#define MIM_ENABLE_CLANG_WARNING_AS_ERROR(w) _Pragma("clang diagnostic push") _Pragma(MIMCLANGWERRORHELP2(w))
	#else
		#define MIM_DISABLE_CLANG_WARNING(w)
	#endif
#endif
	...
	#if defined(MIM_COMPILER_CLANG) || defined(MIM_COMPILER_CLANG_CL)
		#define MIM_DISABLE_CLANG_WARNING_AS_ERROR() _Pragma("clang diagnostic pop")
	#else
