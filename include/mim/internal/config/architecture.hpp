...
// GCC defines: __aarch64__
    ...
    #if defined(MIM_SIMD_SSE) || defined(MIM_SIMD_SSE2) || defined(MIM_SIMD_SSE3) || defined(MIM_SIMD_SSSE3) || defined(MIM_SIMD_SSE4_1) || defined(MIM_SIMD_SSE4_2) || defined(MIM_SIMD_AVX) || defined(MIM_SIMD_AVX2) || defined(MIM_SIMD_AVX512BW) || defined(MIM_SIMD_AVX512CD) || defined(MIM_SIMD_AVX512DQ) || defined(MIM_SIMD_AVX512ER) || defined(MIM_SIMD_AVX512F) || defined(MIM_SIMD_AVX512PF) || defined(MIM_SIMD_AVX512VL) || defined(MIM_SIMD_NEON)
        #define MIM_SIMD 1
    #else
        #undef MIM_SIMD
    #endif
