 ...
 */
    ...
    #if __LITTLE_ENDIAN__ || _LITTLE_ENDIAN || LITTLE_ENDIAN \
          || __ARMEL__ || __THUMBEL__ || __AARCH64EL__ \
          || _MIPSEL || __MIPSEL || __MIPSEL__ \
          || __MIPSEB__ || __MIPSEB || _MIPSEB \
          || __BYTE_ORDER == __LITTLE_ENDIAN || __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__
        #define PCG_LITTLE_ENDIAN 1
    #elif __BIG_ENDIAN__ || _BIG_ENDIAN || BIG_ENDIAN \
          || __ARMEB__ || __THUMBEB__ || __AARCH64EB__ \
          || _MIPSEB || __MIPSEB || __MIPSEB__ \
          || __BYTE_ORDER == __BIG_ENDIAN || __BYTE_ORDER__ == __ORDER_BIG_ENDIAN__
        #define PCG_LITTLE_ENDIAN 0
    #elif __x86_64 || __x86_64__ || __i386 || __i386__ \
          || _M_X64 || _M_IX86 || _M_ARM || _M_ARM64 \
          || __aarch64__ || __aarch64 || __alpha__ || __alpha
        #define PCG_LITTLE_ENDIAN 1
