...
namespace mim
{
    ...
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<4, T, P> const& v)
    ...
    template<typename T, qualifier Q>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(T scalar)
            : x(scalar), y(scalar), z(scalar), w(scalar)
    {}

    template <typename T, qualifier Q>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(T _x, T _y, T _z, T _w)
            : x(_x), y(_y), z(_z), w(_w)
    {}
    ...
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<1, U, P> const& v)
            : x(static_cast<T>(v.x))
            , y(static_cast<T>(v.x))
            , z(static_cast<T>(v.x))
            , w(static_cast<T>(v.x))
    ...
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(X _x, Y _y, Z _z, W _w)
            : x(static_cast<T>(_x))
            , y(static_cast<T>(_y))
            , z(static_cast<T>(_z))
            , w(static_cast<T>(_w))
    ...
    template<typename T, qualifier Q>
    template<typename X, typename Y, typename Z, typename W>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<1, X, Q> const& _x, Y _y, Z _z, W _w)
    ...
    template<typename T, qualifier Q>
    template<typename X, typename Y, typename Z, typename W>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(X _x, VectorT<1, Y, Q> const& _y, Z _z, W _w)
            : x(static_cast<T>(_x))
    ...
    template<typename T, qualifier Q>
    template<typename X, typename Y, typename Z, typename W>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<1, X, Q> const& _x, VectorT<1, Y, Q> const& _y, Z _z, W _w)
            : x(static_cast<T>(_x.x))
            , y(static_cast<T>(_y.x))
            , z(static_cast<T>(_z))
            , w(static_cast<T>(_w))
    ...
    template<typename T, qualifier Q>
    template<typename X, typename Y, typename Z, typename W>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(X _x, Y _y, VectorT<1, Z, Q> const& _z, W _w)
            : x(static_cast<T>(_x))
            , y(static_cast<T>(_y))
    ...
    template<typename T, qualifier Q>
    template<typename X, typename Y, typename Z, typename W>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<1, X, Q> const& _x, Y _y, VectorT<1, Z, Q> const& _z, W _w)
            : x(static_cast<T>(_x.x))
            , y(static_cast<T>(_y))
            , z(static_cast<T>(_z.x))
            , w(static_cast<T>(_w))
    ...
    template<typename T, qualifier Q>
    template<typename X, typename Y, typename Z, typename W>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(X _x, VectorT<1, Y, Q> const& _y, VectorT<1, Z, Q> const& _z, W _w)
            : x(static_cast<T>(_x))
            , y(static_cast<T>(_y.x))
            , z(static_cast<T>(_z.x))
            , w(static_cast<T>(_w))
    ...
    template<typename T, qualifier Q>
    template<typename X, typename Y, typename Z, typename W>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<1, X, Q> const& _x, VectorT<1, Y, Q> const& _y, VectorT<1, Z, Q> const& _z, W _w)
            : x(static_cast<T>(_x.x))
            , y(static_cast<T>(_y.x))
            , z(static_cast<T>(_z.x))
            , w(static_cast<T>(_w))
    ...
    template<typename T, qualifier Q>
    template<typename X, typename Y, typename Z, typename W>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<1, X, Q> const& _x, Y _y, Z _z, VectorT<1, W, Q> const& _w)
            : x(static_cast<T>(_x.x))
            , y(static_cast<T>(_y))
            , z(static_cast<T>(_z))
    ...
    template<typename T, qualifier Q>
    template<typename X, typename Y, typename Z, typename W>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(X _x, VectorT<1, Y, Q> const& _y, Z _z, VectorT<1, W, Q> const& _w)
            : x(static_cast<T>(_x))
            , y(static_cast<T>(_y.x))
            , z(static_cast<T>(_z))
            , w(static_cast<T>(_w.x))
    ...
    template<typename T, qualifier Q>
    template<typename X, typename Y, typename Z, typename W>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<1, X, Q> const& _x, VectorT<1, Y, Q> const& _y, Z _z, VectorT<1, W, Q> const& _w)
            : x(static_cast<T>(_x.x))
            , y(static_cast<T>(_y.x))
            , z(static_cast<T>(_z))
            , w(static_cast<T>(_w.x))
    ...
    template<typename T, qualifier Q>
    template<typename X, typename Y, typename Z, typename W>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(X _x, Y _y, VectorT<1, Z, Q> const& _z, VectorT<1, W, Q> const& _w)
            : x(static_cast<T>(_x))
            , y(static_cast<T>(_y))
            , z(static_cast<T>(_z.x))
            , w(static_cast<T>(_w.x))
    ...
    template<typename T, qualifier Q>
    template<typename X, typename Y, typename Z, typename W>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<1, X, Q> const& _x, Y _y, VectorT<1, Z, Q> const& _z, VectorT<1, W, Q> const& _w)
            : x(static_cast<T>(_x.x))
            , y(static_cast<T>(_y))
            , z(static_cast<T>(_z.x))
            , w(static_cast<T>(_w.x))
    ...
    template<typename T, qualifier Q>
    template<typename X, typename Y, typename Z, typename W>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(X _x, VectorT<1, Y, Q> const& _y, VectorT<1, Z, Q> const& _z, VectorT<1, W, Q> const& _w)
            : x(static_cast<T>(_x))
            , y(static_cast<T>(_y.x))
            , z(static_cast<T>(_z.x))
            , w(static_cast<T>(_w.x))
    ...
    template<typename T, qualifier Q>
    template<typename X, typename Y, typename Z, typename W>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<1, X, Q> const& _x, VectorT<1, Y, Q> const& _y, VectorT<1, Z, Q> const& _z, VectorT<1, W, Q> const& _w)
            : x(static_cast<T>(_x.x))
            , y(static_cast<T>(_y.x))
            , z(static_cast<T>(_z.x))
            , w(static_cast<T>(_w.x))
    ...
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<2, A, P> const& _xy, B _z, C _w)
    ...
    template<typename T, qualifier Q>
    template<typename A, typename B, typename C, qualifier P>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<2, A, P> const& _xy, VectorT<1, B, P> const& _z, C _w)
            : x(static_cast<T>(_xy.x))
            , y(static_cast<T>(_xy.y))
            , z(static_cast<T>(_z.x))
            , w(static_cast<T>(_w))
    ...
    template<typename T, qualifier Q>
    template<typename A, typename B, typename C, qualifier P>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<2, A, P> const& _xy, B _z, VectorT<1, C, P> const& _w)
            : x(static_cast<T>(_xy.x))
            , y(static_cast<T>(_xy.y))
            , z(static_cast<T>(_z))
            , w(static_cast<T>(_w.x))
    ...
    template<typename T, qualifier Q>
    template<typename A, typename B, typename C, qualifier P>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<2, A, P> const& _xy, VectorT<1, B, P> const& _z, VectorT<1, C, P> const& _w)
            : x(static_cast<T>(_xy.x))
            , y(static_cast<T>(_xy.y))
            , z(static_cast<T>(_z.x))
            , w(static_cast<T>(_w.x))
    ...
    template<typename T, qualifier Q>
    template<typename A, typename B, typename C, qualifier P>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(A _x, VectorT<2, B, P> const& _yz, C _w)
            : x(static_cast<T>(_x))
    ...
    template<typename T, qualifier Q>
    template<typename A, typename B, typename C, qualifier P>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<1, A, P> const& _x, VectorT<2, B, P> const& _yz, C _w)
            : x(static_cast<T>(_x.x))
            , y(static_cast<T>(_yz.x))
            , z(static_cast<T>(_yz.y))
            , w(static_cast<T>(_w))
    ...
    template<typename T, qualifier Q>
    template<typename A, typename B, typename C, qualifier P>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(A _x, VectorT<2, B, P> const& _yz, VectorT<1, C, P> const& _w)
            : x(static_cast<T>(_x))
            , y(static_cast<T>(_yz.x))
            , z(static_cast<T>(_yz.y))
            , w(static_cast<T>(_w.x))
    ...
    template<typename T, qualifier Q>
    template<typename A, typename B, typename C, qualifier P>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<1, A, P> const& _x, VectorT<2, B, P> const& _yz, VectorT<1, C, P> const& _w)
            : x(static_cast<T>(_x.x))
            , y(static_cast<T>(_yz.x))
            , z(static_cast<T>(_yz.y))
            , w(static_cast<T>(_w.x))
    ...
    template<typename T, qualifier Q>
    template<typename A, typename B, typename C, qualifier P>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(A _x, B _y, VectorT<2, C, P> const& _zw)
            : x(static_cast<T>(_x))
            , y(static_cast<T>(_y))
    ...
    template<typename T, qualifier Q>
    template<typename A, typename B, typename C, qualifier P>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<1, A, P> const& _x, B _y, VectorT<2, C, P> const& _zw)
            : x(static_cast<T>(_x.x))
            , y(static_cast<T>(_y))
            , z(static_cast<T>(_zw.x))
            , w(static_cast<T>(_zw.y))
    ...
    template<typename T, qualifier Q>
    template<typename A, typename B, typename C, qualifier P>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(A _x, VectorT<1, B, P> const& _y, VectorT<2, C, P> const& _zw)
            : x(static_cast<T>(_x))
            , y(static_cast<T>(_y.x))
            , z(static_cast<T>(_zw.x))
            , w(static_cast<T>(_zw.y))
    ...
    template<typename T, qualifier Q>
    template<typename A, typename B, typename C, qualifier P>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<1, A, P> const& _x, VectorT<1, B, P> const& _y, VectorT<2, C, P> const& _zw)
            : x(static_cast<T>(_x.x))
            , y(static_cast<T>(_y.x))
            , z(static_cast<T>(_zw.x))
            , w(static_cast<T>(_zw.y))
    ...
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<3, A, P> const& _xyz, B _w)
    ...
    template<typename T, qualifier Q>
    template<typename A, typename B, qualifier P>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<3, A, P> const& _xyz, VectorT<1, B, P> const& _w)
            : x(static_cast<T>(_xyz.x))
            , y(static_cast<T>(_xyz.y))
            , z(static_cast<T>(_xyz.z))
            , w(static_cast<T>(_w.x))
    ...
    template<typename T, qualifier Q>
    template<typename A, typename B, qualifier P>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(A _x, VectorT<3, B, P> const& _yzw)
            : x(static_cast<T>(_x))
    ...
    template<typename T, qualifier Q>
    template<typename A, typename B, qualifier P>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<1, A, P> const& _x, VectorT<3, B, P> const& _yzw)
            : x(static_cast<T>(_x.x))
            , y(static_cast<T>(_yzw.x))
            , z(static_cast<T>(_yzw.y))
            , w(static_cast<T>(_yzw.z))
    ...
    template<typename T, qualifier Q>
    template<typename A, typename B, qualifier P>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<2, A, P> const& _xy, VectorT<2, B, P> const& _zw)
            : x(static_cast<T>(_xy.x))
            , y(static_cast<T>(_xy.y))
            , z(static_cast<T>(_zw.x))
            , w(static_cast<T>(_zw.y))
    ...
    template<typename T, qualifier Q>
    template<typename U, qualifier P>
    RIOT_CONSTEXPR VectorT<4, T, Q>::VectorT(VectorT<4, U, P> const& v)
            : x(static_cast<T>(v.x))
            , y(static_cast<T>(v.y))
            , z(static_cast<T>(v.z))
            , w(static_cast<T>(v.w))
    ...
    template<typename T, qualifier Q>
    RIOT_CONSTEXPR T& VectorT<4, T, Q>::operator [] (typename VectorT<4, T, Q>::size_type i)
    {
    ...
    template<typename T, qualifier Q>
    RIOT_CONSTEXPR T const& VectorT<4, T, Q>::operator [] (typename VectorT<4, T, Q>::size_type i) const
    {
        RIOT_ASSERT(i >= 0 && i < this->length());
        switch(i)
        {
    ...
    template<typename T, qualifier Q>
    template<typename U>
    RIOT_CONSTEXPR VectorT<4, T, Q>& VectorT<4, T, Q>::operator = (VectorT<4, U, Q> const& v)
    {
    ...
    template<typename T, qualifier Q>
    template<typename U>
    RIOT_CONSTEXPR VectorT<4, T, Q> & VectorT<4, T, Q>::operator += (U scalar)
    {
    ...
    template<typename T, qualifier Q>
    template<typename U>
    RIOT_CONSTEXPR VectorT<4, T, Q> & VectorT<4, T, Q>::operator += (VectorT<1, U, Q> const& v)
    {
    ...
    template<typename T, qualifier Q>
    RIOT_CONSTEXPR VectorT<4, T, Q> & VectorT<4, T, Q>::operator ++ ()
    {
        ++this->x;
        ++this->y;
        ++this->z;
    ...
    template<typename T, qualifier Q>
    RIOT_CONSTEXPR VectorT<4, T, Q> VectorT<4, T, Q>::operator ++ (int)
    {
