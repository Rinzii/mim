...
namespace mim::detail
{
    ...
    struct Equal
    {
        static constexpr bool compute(T a, T b)
        {
            return a == b;
        }

        static constexpr bool compute(VectorT<1, T, Q> const& a, VectorT<1, T, Q> const& b)
        {
            return a.x == b.x;
        }

        static constexpr bool compute(VectorT<2, T, Q> const& a, VectorT<2, T, Q> const& b)
        {
        ...
        static constexpr bool compute(VectorT<4, T, Q> const& a, VectorT<4, T, Q> const& b)
        {
    ...
    struct BitwiseNot
    {
        static constexpr bool compute(T a)
        {
            return ~a;
        }

        static constexpr bool compute(VectorT<1, T, Q> const& v)
        {
            return VectorT<1, T, Q>(~v.x);
        }

        static constexpr bool compute(VectorT<2, T, Q> const& v)
        {
            return VectorT<2, T, Q>(~v.x, ~v.y);
        }

        static constexpr bool compute(VectorT<3, T, Q> const& v)
        {
            return VectorT<3, T, Q>(~v.x, ~v.y, ~v.z);
        }

        constexpr static VectorT<4, T, Q> compute(VectorT<4, T, Q> const& v)
        {
