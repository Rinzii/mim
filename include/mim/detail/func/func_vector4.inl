...
namespace mim
{
        ...
        bool VectorT<4, T, Q>::isfinite() const
        {
            return std::isfinite(x);
        }

        template <typename T, qualifier Q>
        VectorT<4, T, Q> VectorT<4, T, Q>::sign() const
        {
            return VectorT<4, T, Q>(mim::math::sign(x));
        }

        template <typename T, qualifier Q>
        VectorT<4, T, Q> VectorT<4, T, Q>::floor() const
        {
            return VectorT<4, T, Q>(mim::math::floor(x));
        }

        template <typename T, qualifier Q>
        VectorT<4, T, Q> VectorT<4, T, Q>::ceil() const
        {
            return VectorT<4, T, Q>(mim::math::ceil(x));
        }

        template <typename T, qualifier Q>
        VectorT<4, T, Q> VectorT<4, T, Q>::round() const
        {
        ...
        template <typename T, qualifier Q>
        VectorT<4, T, Q> VectorT<4, T, Q>::min(const VectorT<4, T, Q>& v) const
        {
            return VectorT<4, T, Q>(mim::math::min(x, v.x));
        }

        template <typename T, qualifier Q>
        VectorT<4, T, Q> VectorT<4, T, Q>::max(const VectorT<4, T, Q>& v) const
        {
        ...
        template <typename T, qualifier Q>
        T VectorT<4, T, Q>::length() const
		{
            return mim::math::sqrt(x * x + y * y + z * z + w * w);
        }

		template <typename T, qualifier Q>
        T VectorT<4, T, Q>::length_squared() const
        {
            return x * x + y * y + z * z + w * w;
        }

		template <typename T, qualifier Q>
		void VectorT<4, T, Q>::normalize()
		{
		...
		template <typename T, qualifier Q>
		VectorT<4, T, Q> VectorT<4, T, Q>::normalized() const
		{
			static_assert(std::is_floating_point<T>::value, "Cannot normalize a non-floating-point vector.");
		...
		template <typename T, qualifier Q>
		bool VectorT<4, T, Q>::is_normalized() const
		{
			static_assert(std::is_floating_point<T>::value, "Cannot normalize a non-floating-point vector.");
		...
		template <typename T, qualifier Q>
		T VectorT<4, T, Q>::distance(const VectorT<4, T, Q>& v) const
        {
            return mim::math::sqrt((x - v.x) * (x - v.x) + (y - v.y) * (y - v.y) + (z - v.z) * (z - v.z) + (w - v.w) * (w - v.w));
        }

		template <typename T, qualifier Q>
		T VectorT<4, T, Q>::distance_squared(const VectorT<4, T, Q>& v) const
        {
